...
#############################################################################################################
"""
def decipher_signatures_run(excecution_parameters, genomes=[0], i=1, totalIterations=1, cpu=-1, mut_context="96"):
    # [AJC 2021-07-05] adapted from decipher_signatures() to run for single replicate
...
def decipher_signatures_combine(excecution_parameters, results, genomes=[0], i=1, totalIterations=1, cpu=-1, mut_context="96"):
    # [AJC 2021-07-05] adapted from decipher_signatures() to combine results across replicates
